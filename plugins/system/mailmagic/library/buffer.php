...
/**
 * Registers a mailmagic:// stream wrapper
 */
class plgSystemMailmagicBuffer
{
	/**
	 * Buffer hash
	 *
...
if (plgSystemMailmagicBuffer::canRegisterWrapper())
{
	stream_wrapper_register('plgSystemMailmagicBuffer', 'plgSystemMailmagicBuffer');
}
